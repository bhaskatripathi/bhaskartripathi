...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["Bhaskar-personal-portfolio", "PDF GPT", "Galactica Fine Tuned", "Fusion GPT", "Portfolio Optimization Recurrent RL", "FinPortRL", "Random Numbers"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">Bhaskar@Lenovo</div>
        ...
        switch (main) {
            ...
            case "code":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-Bhaskar, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
